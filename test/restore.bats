...
# Testing LinkPanel backups
@test "Restore[1]: LinkPanel archive for a non-existing user" {
...
@test "Restore[1]: From LinkPanel [WEB]" {
    local domain="test.linkpanel.com"
    validate_web_domain $userbk $domain 'Hello LinkPanel'
}

@test "Restore[1]: From LinkPanel [DNS]" {
    local domain="test.linkpanel.com"
...
@test "Restore[1]: From LinkPanel [MAIL]" {
    local domain="test.linkpanel.com"
...
@test "Restore[1]: From LinkPanel [MAIL-Account]" {
    local domain="test.linkpanel.com"
...
@test "Restore[1]: From LinkPanel [DB]" {
    run v-list-database $userbk "${userbk}_db"
    assert_success
}

@test "Restore[1]: From LinkPanel [CRON]" {
    run v-list-cron-job $userbk 1
    assert_success
}

@test "Restore[1]: From LinkPanel Cleanup" {
    run v-delete-user $userbk
    assert_success
    refute_output
}
...
@test "Restore[2]: LinkPanel archive over a existing user" {
    if [ -d "$HOMEDIR/$userbk" ]; then
        run v-delete-user $userbk
        assert_success
        refute_output
    ...
    if [ ! -d "$HOMEDIR/$userbk" ]; then
        run v-add-user $userbk $userbk test@linkpanel.com
        assert_success
    fi
...
@test "Restore[2]: From LinkPanel [WEB]" {
    local domain="test.linkpanel.com"
    validate_web_domain $userbk "${domain}" 'Hello LinkPanel'
}

@test "Restore[2]: From LinkPanel [DNS]" {
    local domain="test.linkpanel.com"
...
@test "Restore[2]: From LinkPanel [MAIL]" {
    local domain="test.linkpanel.com"
...
@test "Restore[2]: From LinkPanel [MAIL-Account]" {
    local domain="test.linkpanel.com"
...
@test "Restore[2]: From LinkPanel [DB]" {
    run v-list-database $userbk "${userbk}_db"
    assert_success
}

@test "Restore[2]: From LinkPanel [CRON]" {
    run v-list-cron-job $userbk 1
    assert_success
}

@test "Restore[2]: From LinkPanel Cleanup" {
    run v-delete-user $userbk
    assert_success
    refute_output
}

@test "Restore[3]: LinkPanel (zstd) archive for a non-existing user" {
    if [ -d "$HOMEDIR/$userbk" ]; then
        run v-delete-user $userbk
        assert_success
        refute_output
...
@test "Restore[3]: From LinkPanel [WEB]" {
    local domain="test.linkpanel.com"
    validate_web_domain $userbk $domain 'Hello LinkPanel'
}

@test "Restore[3]: From LinkPanel [WEB] FTP" {
    local domain="test.linkpanel.com"
    assert_file_contains /etc/passwd "$userbk_test"
    assert_file_contains /etc/passwd "/home/$userbk/web/$domain"
}

@test "Restore[3]: From LinkPanel [WEB] Awstats" {
    local domain="test.linkpanel.com"
    assert_file_exist /home/$userbk/conf/web/$domain/awstats.conf
}

@test "Restore[3]: From LinkPanel [WEB] Custom rule" {
    # check if custom rule is still working
    local domain="test.linkpanel.com"
    validate_web_domain $userbk $domain 'linkpanel-yes' '/linkpanel/linkpanel' 'no'
}


@test "Restore[3]: From LinkPanel [DNS]" {
    local domain="test.linkpanel.com"
...
@test "Restore[3]: From LinkPanel [MAIL]" {
    local domain="test.linkpanel.com"
...
@test "Restore[3]: From LinkPanel [MAIL-Account]" {
    local domain="test.linkpanel.com"
...
@test "Restore[3]: From LinkPanel [DB]" {
    run v-list-database $userbk "${userbk}_db"
    assert_success
}

@test "Restore[3]: From LinkPanel [CRON]" {
    run v-list-cron-job $userbk 1
    assert_success
}


@test "Restore[3]: From LinkPanel Cleanup" {
    run v-delete-user $userbk
    assert_success
    refute_output
}

@test "Restore[4]: LinkPanel (zstd) archive for a existing user" {
    if [ -d "$HOMEDIR/$userbk" ]; then
        run v-delete-user $userbk
        assert_success
        refute_output
...
@test "Restore[4]: From LinkPanel [WEB]" {
    local domain="test.linkpanel.com"
    validate_web_domain $userbk $domain 'Hello LinkPanel'
}

@test "Restore[4]: From LinkPanel [WEB] FTP" {
    local domain="test.linkpanel.com"
    assert_file_contains /etc/passwd "$userbk_test"
    assert_file_contains /etc/passwd "/home/$userbk/web/$domain"
}

@test "Restore[4]: From LinkPanel [WEB] Awstats" {
    local domain="test.linkpanel.com"
    assert_file_exist /home/$userbk/conf/web/$domain/awstats.conf
}

@test "Restore[4]: From LinkPanel [WEB] Custom rule" {
    # check if custom rule is still working
    local domain="test.linkpanel.com"
    validate_web_domain $userbk $domain 'linkpanel-yes' '/linkpanel/linkpanel' 'no'
}
...
@test "Restore[4]: From LinkPanel [DNS]" {
    local domain="test.linkpanel.com"
...
@test "Restore[4]: From LinkPanel [MAIL]" {
    local domain="test.linkpanel.com"
...
@test "Restore[4]: From LinkPanel [MAIL-Account]" {
    local domain="test.linkpanel.com"
...
@test "Restore[4]: From LinkPanel [DB]" {
    run v-list-database $userbk "${userbk}_db"
    assert_success
}

@test "Restore[4]: From LinkPanel [CRON]" {
    run v-list-cron-job $userbk 1
    assert_success
}

@test "Restore[4]: From LinkPanel Cleanup" {
    run v-delete-user $userbk
    assert_success
    refute_output
}
