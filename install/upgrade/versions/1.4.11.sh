...
# LinkPanel Control Panel upgrade script for target version 1.4.11
...
if [ "$FIREWALL_SYSTEM" = "iptables" ]; then
	...
	rm -f /usr/lib/networkd-dispatcher/routable.d/10-linkpanel-iptables /etc/network/if-pre-up.d/linkpanel-iptables
