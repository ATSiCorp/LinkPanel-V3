		...
		<div class="container">
			<div class="output-card">
				...
				<CopyToClipboardInput
					class="u-mb10"
					value="wget https://raw.githubusercontent.com/ATSiCorp/LinkPanel-V3/release/install/linkpnl-install.sh"
				/>
				<p class="u-mb10">
...
const installCommand = ref("bash linkpnl-install.sh");
watchEffect(() => {
	let cmd = "bash linkpnl-install.sh";
