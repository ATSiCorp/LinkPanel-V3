 ...
 * @param string $user A username for save in the user history ou 'system' to save in LinkPanel history.
 * @return int The script result code.
 */
function linkpnl_add_history_log($message, $category = "System", $level = "Info", $user = "system") {
	...
	exec(LINKPANEL_CMD . "v-log-action " . $command_args, $output, $return_var);
	unset($output);
