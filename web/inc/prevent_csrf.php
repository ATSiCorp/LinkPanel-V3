...
if (
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/linkpanel/web/inc/mail-wrapper.php" ||
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/linkpanel//web/inc/mail-wrapper.php"
) {
	$check_csrf = false;
...
if (
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/linkpanel/web/api/index.php" ||
	$_SERVER["SCRIPT_FILENAME"] == "/usr/local/linkpanel/web//api/index.php"
) {
	$check_csrf = false;
} // Own check
if (substr($_SERVER["SCRIPT_FILENAME"], 0, 22) == "/usr/local/linkpanel/bin/") {
	$check_csrf = false;
}
